...
class Envelope (Model):
    ...
    # def clear_iter_inputs(self): # embedd in mother model class
    #
    #     for inp_l in self.inputs_order:
    #         for k in inp_l:
    #             self.inputs[k] = None
    # def clear_iter_outputs(self): #embedd in mother model class
    #
    #     for out_l in self.outputs_order:
    #         for k in out_l:
    #             self.outputs[k] = None
    # def itr_step(self):
    #     for i in range(len(self.inputs_order)):
    #         if all(self.inputs[k] for k in self.inputs_order[i]):
    #             return i
    #     return -1
    ...
    def step(self, ts, **kwargs):
        ...
        # self.clear_iter_outputs()
        # itr = self.itr_step() # can be in federate and modify kwargs of step # tell us which inputs have been received (first slot secondo slot etc..)
        if kwargs['itr'] == 0: #firts step using non iteration inputs
            mod_run = 0
