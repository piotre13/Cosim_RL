...
q_1 = np.array(RL_data['Envelope/0/Envelope']['outputs']['zone.vent_q 8674'])
q_2 = np.array(RL_data['Envelope/0/Envelope']['outputs']['zone.vent_q 8677'])
q_3 = np.array(RL_data['Envelope/0/Envelope']['outputs']['zone.vent_q 8680'])
q_4 = np.array(RL_data['Envelope/0/Envelope']['outputs']['zone.vent_q 8692'])
q_5 = np.array(RL_data['Envelope/0/Envelope']['outputs']['zone.vent_q 73086'])
...
plt.plot(q_2[0:24], label='q2', marker='o')
plt.plot(q_2B[0:24], label='q2B', marker='o')
